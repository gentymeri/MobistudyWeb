...
`,
    ...
    collectedDatatapping: `    \u2022 Your finger tapping data will be collected.`,
...
\u2022 Malmö University's data protection officer at dataskyddsombud@mau.se`,
  ...
  consent: {
    ...
    taskItemtapping: 'I agree to send my data collected by the finger tapping task, {scheduling}'
  },
  scheduling: {
